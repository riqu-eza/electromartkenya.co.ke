                    ...
                    <div className='w-full  h-full flex-col md:flex-row flex items-start justify-center'>
                        ...
                        <div className='md:w-2/3 w-full px-2 h-full flex-col items-end justify-end flex'>
                            <div className='w-full flex flex-col items-center py-2 overflow-auto h-96'>
                                {
                                    cartData?.length === 0 ?
                                        <div className='w-full h-full flex items-center justify-center flex-col'>
                                            <p className='my-4 mx-2 text-lg text-red-800 font-semibold '>No Item Available in Cart</p>
                            ...
                            <div className='w-full  py-2 my-2 flex justify-end '>
                                <h1 className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm text-black flex flex-col '>  Original Price  <span className='text-xl font-extrabold'>Kshs {totalPrice || 0}</span> </h1>
                                <h1 className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm text-black flex flex-col '>  Shipping Price  <span className='text-xl font-extrabold'>Kshs {500}</span> </h1>
                                <h1 className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm text-black flex flex-col '>  tax Price  <span className='text-xl font-extrabold'>Kshs {100}</span> </h1>
                            </div>
                            <div className='w-full  py-2 my-2 flex justify-end '>
                                <h1 className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm text-black  flex flex-col '>  Total Order Price  <span className='text-xl font-extrabold'>Kshs {totalPrice + 600}</span> </h1>
                            </div>
                        </div>
